...
# ----------------------------
# Filter only campaign_id = "851136207"
# ----------------------------
df['campaign_id'] = df['campaign_id'].astype(str)
df = df[df['campaign_id'] == '851136207'].reset_index(drop=True)
...
for n in n_list:
    ...
    decoded_run_df = decode_df(full_history.copy())  # decode to get decoded text columns
    decoded_run_df['n'] = n
